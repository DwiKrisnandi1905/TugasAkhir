                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('password.update') }}" method="POST">
                            ...
                            <div class="input-group mb-3">
                                <input type="password" id="password_confirmation" name="password_confirmation" class="form-control input" required>
                                <label for="password_confirmation" class="form-label label">Confirm Password:</label>
                            </div>

                        ...
                        <div class="col-md-3 mb-4 d-flex align-items-stretch">
                            <div class="card h-100">
                                <div class="select-item-container">
                                    <input type="checkbox" class="select-item" id="select-{{ $item->id }}" data-id="{{ $item->id }}" data-nama="{{ $item->nama_produk }}" data-warna="{{ $item->warna }}" data-ukuran="{{ $item->ukuran }}" data-kuantitas="{{ $item->kuantitas }}" data-hargasatuan="{{ $item->harga_satuan }}" data-totalharga="{{ $item->total_harga }}" data-image="{{ $item->image }}" data-produk="{{ $item->produk_id }}">
                                    <label for="select-{{ $item->id }}"></label>
                                </div>
                                <img src="{{ asset('images/' . $item->image) }}" class="card-img-top" alt="{{ $item->nama_produk }}">
                                <div class="card-body text-start">
                                    <p class="card-text"><strong>id:</strong> {{ $item->produk_id }}</p>
